...
describe("Bentobox set strategy profit", () => {
    ...
    it('Set strategy profit!', async () => {
        ...
        assert.ok(pool_vault_acc.amount.toString() == "300");
        ...
        assert.equal(bentobox_vault_acc.amount.toString(), "2100");

        total_info_data = await bentoboxProgram.account.total.fetch(bentobox.getTotalDataPda(mint.publicKey));
        assert.equal(total_info_data.amount["elastic"].toString(), "2100");
