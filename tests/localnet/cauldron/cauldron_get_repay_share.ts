...
describe("Get repay share", () => {
    ...
    it("Get repay share", async () => {
        try {
            await cauldronProgram.methods.getRepayShare(new BN(50))
                .accounts({
        ...
        let tx = await cauldronProgram.methods.getRepayShare(new BN(50))
            .accounts({
                cauldronAccount: cauldron.getCauldronAccount(),
                totalData: cauldron.getTotalDataPda(),
                bentoboxAccount: bentobox.getBentoboxAccount(),
